    ...
    <header className={`w-full ${isSticky ? 'bg-white' : 'bg-transparent'} fixed top-0 left-0 right-0 duration-300`}>
      <nav className={`py-4 lg:px-14 px-4 ${isSticky ? "sticky top-0 left-0 right-0 border-b bg-white" : ""}`}>
        <div className='flex justify-between items-center text-base gap-8'>
          <RouterLink to="/"> {/* Changed Link to RouterLink */}
          ...
          <RouterLink to="/"> 
            <button className="bg-naturalPrimary text-white py-2 px-4 transition-all duration-300 rounded hover:bg-naturalDGrey">HOME</button>
          </RouterLink>
